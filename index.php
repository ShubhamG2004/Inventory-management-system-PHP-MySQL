...
?>
<body style="background: linear-gradient(135deg, #e0eafc 0%, #cfdef3 100%); font-family: 'Inter', 'Segoe UI', 'Roboto', 'Arial', sans-serif;">
...
<style>
	...
	.modern-nav .nav-link.active, .modern-nav .nav-link:hover {
	...
	.modern-btn-success { background: linear-gradient(90deg, #43e97b 0%, #38f9d7 100%); color: #fff; border: none; }
	.modern-btn-primary { background: linear-gradient(90deg, #2193b0 0%, #6dd5ed 100%); color: #fff; border: none; }
	.modern-btn-danger { background: linear-gradient(90deg, #ee0979 0%, #ff6a00 100%); color: #fff; border: none; }
	.modern-btn-dark { background: #34495e; color: #fff; border: none; }
	.modern-btn-warning { background: linear-gradient(90deg, #f7971e 0%, #ffd200 100%); color: #fff; border: none; }
	.modern-table-responsive { border-radius: 12px; overflow: hidden; background: #fff; box-shadow: 0 2px 12px rgba(44,62,80,0.07); }
	.modern-table { width: 100%; border-collapse: collapse; }
	.modern-table th, .modern-table td { padding: 0.75rem 1rem; border-bottom: 1px solid #eaeaea; }
	.modern-table th { background: #f4f6f8; font-weight: 600; color: #2193b0; }
	.modern-table tr:last-child td { border-bottom: none; }
</style>
<div class="container-fluid py-4">
	<div class="row gx-5 gy-4">
		<div class="col-lg-2">
			<nav class="modern-nav h-100 d-flex flex-column justify-content-start align-items-center">
				<h2 class="mb-4 text-center modern-header">Inventory</h2>
				<div class="nav flex-column nav-pills w-100 gap-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true"><i class="fas fa-box"></i> Item</a>
					<a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false"><i class="fas fa-shopping-cart"></i> Purchase</a>
					<a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false"><i class="fas fa-truck"></i> Vendor</a>
					<a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false"><i class="fas fa-cash-register"></i> Sale</a>
					<a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false"><i class="fas fa-user"></i> Customer</a>
					<a class="nav-link" id="v-pills-search-tab" data-toggle="pill" href="#v-pills-search" role="tab" aria-controls="v-pills-search" aria-selected="false"><i class="fas fa-search"></i> Search</a>
					<a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false"><i class="fas fa-chart-bar"></i> Reports</a>
				</div>
			</nav>
		</div>
		<div class="col-lg-10">
